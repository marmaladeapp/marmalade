class Business < ActiveRecord::Base
  ...
  validates :slug, format: { without: /\A(?:admin|about|login|signin|signup|register|terms-of-service|privacy-policy|feedback|users|businesses|households|groups|contacts|calendars|time|inventory|finances|projects)\Z/i, message: "restricted." }
