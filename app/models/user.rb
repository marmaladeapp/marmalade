class User < ActiveRecord::Base
  ...
  validates :username, format: { without: /\A(?:admin|about|login|signin|signup|register|terms-of-service|privacy-policy|feedback|users|businesses|households|groups|contacts|calendars|time|finances|projects)\Z/i, message: "restricted." }
